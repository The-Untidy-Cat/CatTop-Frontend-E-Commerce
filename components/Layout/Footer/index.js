...
export default function Footer() {
  return (
    <footer className="w-full h-fit shrink-0 grow-0">
      <div className="flex justify-center border-b px-5 py-4 md:py-7 shrink-0 bg-primary/[.4] w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 content-center lg:max-w-4xl w-full gap-3 md:gap-5">
